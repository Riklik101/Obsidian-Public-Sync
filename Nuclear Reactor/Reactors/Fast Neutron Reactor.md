A Fast Neutron Reactor is a specific type of reactor that different from a [[Thermal Reactor]]-- it is not very common because unlike a thermal reactor that uses neutron to sustain the chain reaction, a FNR has no neutron moderation and less primary coolant due to an excess of fast neutrons
...
![[FNR vs Thermal NE-Flux.png|400]]
