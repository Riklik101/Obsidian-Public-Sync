...
- `BLOG_REPO`: Next.JS app repository template that is used to publish your markdown notes. This is useful when you [[public-sync/publish/publish stuff/deploy-a-custom-linked-blog-starter|create your own custom linked blog]]
